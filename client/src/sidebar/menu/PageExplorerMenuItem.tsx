...
export class PageExplorerMenuItemDefinition extends LinkMenuItemDefinition {
  ...
  constructor(
    { name, label, url, icon_name: iconName = null, classnames = undefined }: { name: string, label: string, url: string, icon_name: string | null, classnames?: string},
    startPageId: number,
  ) {
  ...
  render({ path, state, dispatch, navigate }: MenuItemRenderContext) {
    return (
